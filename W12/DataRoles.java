	...
	void displayRoleDesc() {
        switch (EngRole) {
            ...
            case "Machine Learning Engineer":
              System.out.println("They are a very specialized type of backend software engineer focusing on leveraging data."
              		+ "They operationlize and put predictive models into production, building pipelines, api and training models.");
              break;
